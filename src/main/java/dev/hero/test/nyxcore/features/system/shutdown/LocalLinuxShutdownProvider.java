...
@Component
@Order(1)
public class LocalLinuxShutdownProvider implements ShutdownProvider {
    ...
    @Override
    public ProviderResult shutdown(String user, String ip, String port, String keypath) {
        ...
        try {
            ...
            return ProviderResult.success("Shutdown command executed successfully.", exitCode, output);
